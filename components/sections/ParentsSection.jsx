...
export default function ParentsSection() {
  ...
  return (
    <section 
      ...
      id="parents" 
      className={`py-20 ${isInView ? 'bg-parallax' : ''}`}
    >
          ...
          <div className="relative">
            ...
            <div className="relative p-6 rounded-2xl z-10 text-center space-y-8 py-12 text-white">
              ...
              <div className={getAnimationClass(messageVisible, 'fade-in-up', 'delay-200')}>
                <p className="text-lg italic max-w-2xl mx-auto leading-relaxed text-amber-600">
                  {parents.message}
                </p>
              </div>
              ...
              <div className="space-y-8">
                ...
                <div 
                style={{display:'none'}}
                className={`${getAnimationClass(parentsVisible, 'slide-in-left', 'delay-400')} parent-card`}>
