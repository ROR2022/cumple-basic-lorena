export const quinceMainData = {
  hero: {
    name: "Lorena",
    subtitle: "¡Mi Cumple 60!",
    backgroundImage: "/images/fondoLorena1.png",
    quote:
  ...
  event: {
    ...
    parents: {
      ...
      message: `Hoy, mi corazón rebosa de gratitud. 
                Doy gracias a Dios por cada paso de mi vida  
    ...
    party: {
      time: "16:00 hrs.",
      venue: "Espacio 828 Salón",
      address: "80050 Calle claveles 2678 esquina con, Villa Andalucía, Villas del Río, 80050 Culiacán Rosales, Sin.",
      type: "Recepción",
      ubiLink: "https://maps.app.goo.gl/1ybPChk5tpt8mZsy5",
    },
  ...
  attendance: {
    whatsappNumber: "5216672060356", //+52 1 667 206 0356
